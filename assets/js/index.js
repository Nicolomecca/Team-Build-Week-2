    ...
    cardsAlbumRow.innerHTML += `
        <div class="col-12 col-md-3 mb-3 rounded scaleHover"
          ...
          <div class="position-relative">
            ...
            <button type="button" class="btn  btn-primary  position-absolute bottom-10 end-5  d-none rounded-circle circle-button "><i class="bi bi-play-fill fs-4 " onclick="playerTracks(${trackIndex})"></i></button>
            </div>        
